...
urlpatterns =[
    ...
    path('classificationDataC1/<str:number_metrics>/<float:C1>/', views.ClassificationDataSet.getClassificationC1),
    path('classificationDataC1C2/<float:C1>/<float:C2>/', views.ClassificationDataSet.getClassificationC1C2),
